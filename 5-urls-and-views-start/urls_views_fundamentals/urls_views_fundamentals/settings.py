...
SECRET_KEY = "django-insecure-3rj3p=-amu8*8omjab_wsg8&fnu1agl@np%an+en6tlw(xizht"
...
# predefined apps, imported from other
# sources but we have to let our django
# project know about the app we've created
INSTALLED_APPS = [
